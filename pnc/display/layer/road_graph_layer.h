...
#include "pnc/display/layer/road_graph_layer_base.h"
...
class RoadGraphLayer : public RoadGraphLayerBase {
 public:
  RoadGraphLayer(const std::string& name, const pnc::map::MapLib* map_lib,
 ...
 private:
  ...
  const interface::simulation::SimulationSystemData& simulation_world_data_;
